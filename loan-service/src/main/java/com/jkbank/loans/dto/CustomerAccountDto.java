...
@Schema(
        name = "Customer",
        description = "Schema to hold customer and basic account information"
)
// Data Transfer Object representing customer account information to get data from Accounts Service to send in loan creation communication event
